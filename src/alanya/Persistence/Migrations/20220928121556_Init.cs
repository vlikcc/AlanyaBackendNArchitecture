        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReciepeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReciepeCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockInReciepes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockInReciepes_Reciepes_ReciepeId",
                        column: x => x.ReciepeId,
                        principalTable: "Reciepes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockInReciepes_Stockpiles_StockpileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockInReciepes_ReciepeId",
                table: "StockInReciepes",
                column: "ReciepeId");

            migrationBuilder.CreateIndex(
                name: "IX_StockInReciepes_StockpileId",
                table: "StockInReciepes",
                column: "StockpileId");
